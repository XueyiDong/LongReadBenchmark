...
writeBambuOutput(ont_iso_analysis, path = "/stornext/General/data/user_managed/grpu_mritchie_0/Mei/long_read_benchmark/ONT_sub/downsampled_analysis/bambu", prefix = "ONT_sub_")