---
title: "Benchmarking long-read DE analysis tools"
author: "Xueyi Dong"
date: "05/05/2021"
output: 
  html_document: 
...
write.table(tt.human[,c("logFC", "adj.P.Val")], "DEres/resLimmaHuman.tsv", sep = "\t", row.names = TRUE)
write.table(tt.sequin[,c("logFC", "adj.P.Val")], "DEres/resLimmaSequin.tsv", sep = "\t", row.names = TRUE)
```
...
write.table(ttag.human[,c("logFC", "FDR")], "DEres/resEdgerHuman.tsv", sep="\t", row.names = TRUE)
```
...
write.table(ttag.sequin[,c("logFC", "FDR")], "DEres/resEdgerSequin.tsv", sep="\t", row.names = TRUE)
...
write.table(res.human[,c("log2FoldChange", "padj")], "DEres/resDeseq2human.tsv", sep="\t", row.names = TRUE)
write.table(res.sequin[,c("log2FoldChange", "padj")], "DEres/resDeseq2sequin.tsv", sep="\t", row.names = TRUE)
...
write.table(noires.human[,c("log2FC", "FDR")], "DEres/resNoiseqHuman.tsv", sep="\t", row.names = TRUE)
write.table(noires.sequin[,c("log2FC", "FDR")], "DEres/resNoiseqSequin.tsv", sep="\t", row.names = TRUE)
```
